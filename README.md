...
<br />
<p align="center">
  <a href="https://github.com/secondbrain-io/commit-message-validator">
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/secondbrain-io/commit-message-validator/issues">
      Report Bug
    </a>
    ·
    <a href="https://github.com/secondbrain-io/commit-message-validator/issues">
...
1. Clone the commit-message-validator
   ...
   ```sh
   git clone https://github.com/secondbrain-io/commit-message-validator.git
   ```
  ...
  commit-message-validation:
    ...
    steps:
      ...
      - name: Commit message validation
        uses: secondbrain-io/commit-message-validator@master
        env:
...
repos:
  - repo: https://github.com/secondbrain-io/commit-message-validator
    rev: master
    hooks:
...
See the [open issues](https://github.com/secondbrain-io/commit-message-validator/issues)
...
Project Link: [https://github.com/secondbrain-io/commit-message-validator](https://github.com/secondbrain-io/commit-message-validator)
...
[contributors-shield]: https://img.shields.io/github/contributors/secondbrain-io/commit-message-validator.svg?style=flat-square
[contributors-url]: https://github.com/secondbrain-io/commit-message-validator/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/secondbrain-io/commit-message-validator.svg?style=flat-square
[forks-url]: https://github.com/secondbrain-io/commit-message-validator/network/members
[stars-shield]: https://img.shields.io/github/stars/secondbrain-io/commit-message-validator.svg?style=flat-square
[stars-url]: https://github.com/secondbrain-io/commit-message-validator/stargazers
[issues-shield]: https://img.shields.io/github/issues/secondbrain-io/commit-message-validator.svg?style=flat-square
[issues-url]: https://github.com/secondbrain-io/commit-message-validator/issues
[license-shield]: https://img.shields.io/github/license/secondbrain-io/commit-message-validator.svg?style=flat-square
[license-url]: https://github.com/secondbrain-io/commit-message-validator/blob/master/LICENSE
